#ifndef USV_VECTOR2_H_
#define USV_VECTOR2_H_
...
namespace Vectors {
	...
	public:
        ...
        inline static Vector2 polar(double r, double phi) {
        ...
        /**
         * \brief      Returns the radius of this two-dimensional vector.
         * \return     The r-coordinate of the two-dimensional vector in polar form.
         */
        inline double r() const { return std::sqrt(x_ * x_ + y_ * y_); }

        /**
         * \brief      Returns the phase of this two-dimensional vector.
         * \return     The phi-coordinate of the two-dimensional vector in polar form.
         */
        inline double phi() const { return std::atan2(y_, x_); }
    ...
    /**
	 * \relates    Vector2
	 * \brief      Computes vector with same direction but new length.
	 * \param      vector     The two-dimensional vector to change length.
	 * \param      r          New radius (length).
	 * \return     Vector with new length.
	 */
    inline Vector2 changeR(const Vector2& vector, double r) {
        return r * normalize(vector);
    }

    /**
	 * \relates    Vector2
	 * \brief      Computes vector with same length but new phase.
	 * \param      vector     The two-dimensional vector to change phase.
	 * \param      phi        New phase.
	 * \return     Vector with new phase.
	 */
    inline Vector2 changePhi(const Vector2& oldVector, double phi) {
